...
export function ActionPlansList({ agentId, showCreateButton = true }: ActionPlansListProps) {
  ...
  useEffect(() => {
    if (
      session?.user &&
      session.user.role &&
      ['TEAM_LEADER', 'MANAGER', 'ADMIN'].includes(session.user.role) &&
      !agentId
    ) {
  ...
  const handleCreatePlan = async () => {
    ...
    // Validate items
    const validItems = newPlan.items.filter(
      item =>
        item.title.trim() &&
                          ...
                          <div className="grid grid-cols-2 gap-3">
                            ...
                            <div>
                              ...
                              <Input
                                ...
                                onChange={e =>
                                  handleItemChange(index, 'targetMetric', e.target.value)
                                }
      ...
      <CardContent>
        ...
        {(() => {
          ...
          if (actionPlans.length === 0) {
            return <div className="text-center py-8 text-gray-500">No action plans found</div>;
          }
          return (
            <div className="space-y-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mb-3">
                        ...
                        <div className="flex items-center justify-between text-xs text-gray-500 mt-1">
                          <span>
                            {plan.completedItems} of {plan.totalItems} items completed
                          </span>
                          {plan.status === 'ACTIVE' && (
