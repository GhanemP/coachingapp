  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        {errors.focusAreas && <p className="text-sm text-red-600 mt-2">{errors.focusAreas}</p>}
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="border-2 border-blue-200 rounded-lg p-4 bg-blue-50">
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2">
                ...
                <Button onClick={() => setShowActionItemForm(false)} size="sm" variant="outline">
                  Cancel
                </Button>
              </div>
            </div>
        ...
        {errors.actionItems && <p className="text-sm text-red-600 mt-2">{errors.actionItems}</p>}
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <p className="text-sm text-gray-500 mt-2">
          These notes will help you prepare for the session and ensure all important points are
          covered.
        </p>
      </div>
          ...
          <div className="border-2 border-gray-200 rounded-lg p-4 bg-gray-50">
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2">
                ...
                <Button onClick={() => setShowResourceForm(false)} size="sm" variant="ghost">
                  Cancel
                </Button>
              </div>
            </div>
