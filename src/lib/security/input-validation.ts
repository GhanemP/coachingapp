...
const PATH_TRAVERSAL_PATTERNS = [/\.\./g, /\.\.%2[fF]/g, /%2[eE]\./g, /\x00/g, /[<>:"|?*]/g];
...
export const validationSchemas = {
  ...
  userRegistration: z.object({
    email: z
      .string()
      .email()
      .transform(val => InputValidator.validateEmail(val)),
    password: z.string().min(12).max(128),
    name: z
      .string()
      .min(2)
      .max(100)
      .transform(val => syncSanitizeHTML(val)),
  ...
  actionItem: z.object({
    ...
    description: z
      ...
      .max(2000)
      .optional()
      .transform(val => (val ? syncSanitizeHTML(val) : undefined)),
