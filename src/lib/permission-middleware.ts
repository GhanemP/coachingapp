...
type APIHandler = (request: NextRequest, context?: { params: Promise<Record<string, string>> }) => Promise<NextResponse>;
...
export const requirePermissions = (permissions: string[], requireAll = false) => (handler: APIHandler) =>
