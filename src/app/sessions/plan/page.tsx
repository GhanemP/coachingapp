              ...
              <div
                ...
                className={cn(
                  ...
                  index < STEPS.length - 1 &&
                    "after:content-[''] after:absolute after:top-5 after:left-[50%] after:w-full after:h-0.5 after:bg-gray-300"
                )}
              >
                <button
          ...
          <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg flex items-start gap-3">
            ...
            <div className="text-sm text-blue-800">
              ...
              <ul className="list-disc list-inside space-y-1">
                ...
                <li>
                  Schedule sessions during times when both parties can focus without interruptions
                </li>
